...
export default function Footer() {
  ...
  const listHeThongRap = _.map(cinemasSystem, (cinema) => {
    return _.pick(cinema, ["logo", "tenHeThongRap"]);
  });
  return (
    <footer
      className="px-4  mt-3 divide-y bg-gray-800 text-gray-100  "
      style={{ background: "url(ft-bg.jpg) " }}
    >
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          ...
          >
            <div className="flex items-center justify-center">
              <img src="logo1.png" alt="" width={265} />
            </div>
          </a>
        </div>
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          ...
          <div className="space-y-3">
            <h3 className="uppercase text-gray-50">Partners</h3>
